...
! Subroutine (128-bit) to calculate the determinant
! of a matrix using Lower Decomposition Method

! The arguments of function detmat_128() are:
...
! ALL YOU NEED TO DO:
! Call subroutine detmat_128(n,a,det)
...
!   But the subroutine is independent of this file reading
    ...
    call detmat_128(n,a(1:n,1:n),det)
...
! of a square matrix using Lower Decomposition Method
    subroutine detmat_128(n,aa,det)
    implicit real*16(A-H,O-Z)
    logical exc
