...
! Subroutine (64-bit) to solve a system of linear
! equations using Gaussian Elimination

! The arguments of function gs_elm_64() [to solve Ax=b] are:
...
! ALL YOU NEED TO DO:
! Call subroutine gs_elm_64(n,a,b,x)
...
!   But the subroutine is independent of this file reading
    ...
    call gs_elm_64(n,a(1:n,1:n),b(1:n),x(1:n))
...
! Subroutine (64-bit) to solve a system of linear
! equations using Gaussian Elimination
    subroutine gs_elm_64(n,aa,bb,x)
    implicit real*8(A-H,O-Z)
    logical exc
