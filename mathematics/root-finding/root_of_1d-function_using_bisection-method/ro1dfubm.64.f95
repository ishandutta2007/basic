...
! Subroutine is optimized for minimum calls to f(x)
    ...
    call bsctn_64(g,a0,b0,er,c,istt)
...
! Subroutine (64-bit) to find a root of f(x) using Bisection Method
    subroutine bsctn_64(f,a0,b0,er,c,istt)
    implicit real*8(A-H,O-Z)
    logical ifa,ifb
    external f
    fa=f(a0)
