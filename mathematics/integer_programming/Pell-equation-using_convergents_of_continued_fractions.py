...
# Function to solve Pell's Equation using
...
# non-square integer D (if D is a perfect square, no solutions exist)
...
# ALL YOU NEED TO DO:
# Call pelleq(D, j) with posiitve non-square integer D
#   and positive integer j for first j solutions

# NOTE
# Don't forget to import math
# The trivial solution (1, 0) is ignored
