...
! Subroutine (32-bit) to solve Knapsack 0-1 Problem
...
! ALL YOU NEED TO DO:
! Call subroutine knapsack_01_dp_int32(m,nv,nw,nwm,tt) with:
!   m = number of items
!   nv = values of items
!   nw = weights of items
...
! Output array tt must be defined as a logical array
    ...
    call knapsack_01_dp_int32(m,nv,nw,nwm,tt)
    write(6,*) tt
    end

! Subroutine (32-bit) to solve Knapsack 0-1 Problem
! using Dynamic Programming
    subroutine knapsack_01_dp_int32(m,nv,nw,nwm,tt)
    logical tt
